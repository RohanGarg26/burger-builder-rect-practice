...
export const FETCH_ORDER_START = 'PURCHASE_ORDER_START'
export const FETCH_ORDER_SUCCESS = 'PURCHASE_ORDER_SUCCESS'
export const FETCH_ORDER_FAIL = 'PURCHASE_ORDER_FAIL'
